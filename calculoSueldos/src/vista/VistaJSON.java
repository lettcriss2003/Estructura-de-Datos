...
public class VistaJSON extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbxTipoCalculo = new javax.swing.JComboBox<>();
        ...
        labelJSON.setText("cargue su JSON");
        ...
        cbxTipoCalculo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "array", "lista" }));
        ...
        panelArchivoLayout.setHorizontalGroup(
            ...
            .addGroup(panelArchivoLayout.createSequentialGroup()
                ...
                .addComponent(cbxTipoCalculo, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        panelArchivoLayout.setVerticalGroup(
            ...
            .addGroup(panelArchivoLayout.createSequentialGroup()
                ...
                .addGroup(panelArchivoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(buttonSubirArchivo)
                    .addComponent(cbxTipoCalculo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void buttonSubirArchivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSubirArchivoActionPerformed
        ...
        if (respuesta == JFileChooser.APPROVE_OPTION) {
            ...
            if (tableResultados.getModel().getRowCount() > 0) {
                ...
                tableTemporal.setRowCount(0);
                tableResultados.setModel(tableTemporal);
            }
            DefaultTableModel model = null;
            if (cbxTipoCalculo.getSelectedItem().toString() == "array") {
                model = controladorCalculo.generarTablaPorJSONArray(ruta, (DefaultTableModel) tableResultados.getModel());
            } else {
                model = controladorCalculo.generarTablaPorJSONLista(ruta, (DefaultTableModel) tableResultados.getModel());
            }
    ...
    private javax.swing.JComboBox<String> cbxTipoCalculo;
