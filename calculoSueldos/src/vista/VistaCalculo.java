        ...
        if (tableResultadoCalculo.getModel().getRowCount() > 0) {
            ...
            try {
                if (cbxTipoCalculo.getSelectedItem().toString() == "array") {
                    save.write(controladorCalculo.guardarDatosTablaAJSONArray((DefaultTableModel) tableResultadoCalculo.getModel()));
                } else {
                    save.write(controladorCalculo.guardarDatosTablaAJSONLista((DefaultTableModel) tableResultadoCalculo.getModel()));
                }
